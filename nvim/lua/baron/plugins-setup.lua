...
return packer.startup(function(use)
	...
	--------------------
	--| Language Stuff --
    --> formatting & linting (syntax highlighting) FOR EVERYTHING
    use({
    ...
    -- use("leafOfTree/vim-svelte-plugin") -- svelte
    -- use({
    --     "evanleck/vim-svelte",
    --     branch = 'main',
    --     requires = {
    --         {'pangloss/vim-javascript'},    -- javascript highlighting
    --         {'othree/html5.vim'},           -- html indent
    --     }
    -- })
    ...
    use("mattn/emmet-vim") -- html & css autocompletion & cool snippet stuff
    use("prettier/vim-prettier") -- html formatter
	----------------
	-- Navigation --
